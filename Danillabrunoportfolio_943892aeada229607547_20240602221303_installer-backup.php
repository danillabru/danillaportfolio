...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'Danillabrunoportfolio_943892aeada229607547_20240602221303_archive.zip';
        const ARCHIVE_SIZE       = '2968892776';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '943892a-02221303';
        const SECONDARY_PACKAGE_HASH = '4f95e95-02221303';
        const VERSION            = '1.5.9';
